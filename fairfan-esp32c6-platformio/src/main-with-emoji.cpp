/*
  FairFan ESP32-C6 with Display - PlatformIO Version
...
void setup() {
  ...
  Serial.println("=== FairFan ESP32-C6 PlatformIO - WORKING CONFIGURATION ===");
...
<body>
    <div class="container">
        ...
        <div class="toolchain-info">
            ...
            ✅ PlatformIO ESP32-C6 Support<br>
        ...
        <div class="controls">
            ...
            <button class="btn-mode" onclick="toggleMode()" id="modeBtn">⚙️ Toggle Mode</button>
            <button class="btn-mode" onclick="toggleOscillate()" id="oscBtn">↔️ Toggle Oscillate</button>
        </div>
            ...
            fetch('/api/status')
                ...
                .then(data => {
                    ...
                    statusDiv.innerHTML = 
                        ...
                        `<strong>Mode:</strong> ${data.mode} ⚙️<br>` +
                        `<strong>Oscillating:</strong> ${data.oscillating ? '✅ YES' : '❌ NO'}<br>` +
                        `<strong>Runtime:</strong> ${Math.floor(data.runtime/1000)}s ⏱️<br>` +
